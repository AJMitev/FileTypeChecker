...
namespace FileTypeChecker.Tests.Types
{
    ...
    {
        private new const string Name = "Arbitrary Csv 2 FileType";
        private new const string MimeType = "text/x-arbitrarycsv2filetype";
        private new const string Extension = "arbitrarycsv2filetype";
        ...
        public ArbitraryCsv2FileType() : base(Name, MimeType, Extension, MagicBytesJaggedArray) { }
    }
}